<%-- 
    Document   : signup
    Created on : 6 Dec, 2022, 9:33:48 PM
    Author     : Kavin
--%>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
  ...
  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
          ...
          <li class="nav-item">
            <a class="nav-link active text-danger" href=""><b>Sign Up</b></a>
          </li>
            <li class="nav-item">
        ...
        <section class="vh-100" style="background-image: url(div5.1.webp);">
  <div class="mask d-flex align-items-center h-100 rounded-3">
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100 bg-transparent  ">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          
            <div class="card-body p-4 bg-secondary rounded-5">
                <h2 class="text-uppercase text-center mb-5"><b>Create an account</b></h2>

                <form action="signup1.jsp" method="post">

                <div class="form-outline mb-4">
                    <input type="text" id="form3Example1cg" class="form-control form-control-lg " placeholder="Name" name="Name" required/>
                ...
                <div class="form-outline mb-4">
                    <input type="password" id="form3Example4cdg" class="form-control form-control-lg" placeholder="Repeat your password"  name="Repassword" required/>
                ...
                <p class="text-center  mt-2 mb-0 text-white" >Have already an account? <a href="Login.jsp"
